				...
				<div class="col-sm-3">
					<div class="form-group">
						<img class="img-rounded"
							...
							alt="Generic placeholder image" width="150" height="200" title="Imagen de la pelicula">
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="form-group">
						...
						<!-- Campo hidden para almacenar el id -->
						<form:hidden path="id" />
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<!-- Por cada elemento de la lista genero se genera una etiqueta option -->
